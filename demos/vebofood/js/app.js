...
"use strict";
/* WEBPACK VAR INJECTION */(function($, svg4everybody) {
...
$(function () {
	...
	var searchBtn = document.querySelector('.search-form__button');
	var searchCloseBtn = document.querySelector('.find-favourite__close');
	...
	searchForm.addEventListener('transitionend', function (event) {
		searchForm.querySelector('.search-form__input').focus();
	});

	search.addEventListener('click', openSearchForm);
	searchBtn.addEventListener('click', closeSearchForm);
	...
	var popularItems = document.querySelectorAll('.popular__link');
	var popularItemImg = document.querySelector('.popular__image');
	var resipes = document.querySelectorAll('.resipe');

	popularItems.forEach(function (element) {
	...
	function checkItem(event) {
		...
		// console.log(this.getAttribute('data-resipe'));
		// console.log(this.getAttribute('data-img'));
		popularItemImg.setAttribute('src', 'img/' + this.getAttribute('data-img') + '.jpg');
		resipes.forEach(function (resipe) {
			resipe.style.display = 'none';
		});
		document.querySelector('.resipe[data-answer=' + this.getAttribute('data-resipe') + ']').style.display = 'block';
	}

	$(".hamburger").on('click', function (event) {
		$(this).toggleClass("is-active");
		$('.main-navigation__menu').toggleClass("menu-active");
		event.stopPropagation();
	});

	$(".main-navigation__menu").on('click', function (event) {
		event.stopPropagation();
	});

	$('body').on('click', function () {
		$('.main-navigation__menu').removeClass("menu-active");
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"), __webpack_require__(/*! svg4everybody */ "./node_modules/svg4everybody/dist/svg4everybody.js")))
